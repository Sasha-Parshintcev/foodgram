# Generated by Django 3.2.3 on 2024-06-13 04:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ingredient_in_recipe', to='food.ingredient', verbose_name='Ингредиенты')),
        ...
        migrations.AddField(
            model_name='recipe',
            name='tags',
            field=models.ManyToManyField(help_text='Можно установить несколько тегов на один рецепт', related_name='tags', to='food.Tag', verbose_name='Теги'),
        ),
