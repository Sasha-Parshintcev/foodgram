# Generated by Django 3.2.3 on 2024-06-22 07:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_link', models.CharField(blank=True, max_length=200, null=True, unique=True, verbose_name='Короткая ссылка на рецепт')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipe_in_ingredient', to='food.ingredient', verbose_name='Ингредиенты')),
